...
<div>
  ...
  <div style="margin-bottom:1.25rem; display:flex; align-items:center; justify-content:space-between;">
    <div>
      <h2 style="font-size:1.1rem;font-weight:800;color:var(--text-strong);margin:0;letter-spacing:-.02em;">Ubah Data Pengguna</h2>
      <p style="font-size:.78rem;color:var(--text-muted);margin:.15rem 0 0;">Memperbarui informasi untuk: <strong style="color:var(--brand-primary);">{{ $user->name }}</strong></p>
    </div>
        ...
        <div style="display:flex; flex-direction:column; gap:1.25rem; margin-bottom:1.5rem;">
          ...
          <div class="form-group" style="margin:0;">
            ...
            <div class="input-group">
              ...
              <input type="text" name="name" id="name" value="{{ old('name', $user->name) }}" class="form-input" required style="padding-left:2.5rem;" oninvalid="this.setCustomValidity('Harap isi nama lengkap')" oninput="this.setCustomValidity('')" />
            </div>
          </div>
          ...
          <div class="form-group" style="margin:0;">
            ...
            <div class="input-group">
              ...
              <input type="email" name="email" id="email" value="{{ old('email', $user->email) }}" class="form-input" required style="padding-left:2.5rem;" oninvalid="this.setCustomValidity(this.validity.valueMissing ? 'Harap isi alamat email' : 'Format email tidak valid')" oninput="this.setCustomValidity('')" />
            </div>
          </div>
          ...
          <div class="form-group" style="margin:0;">
            ...
            <div class="input-group" style="position:relative;">
              ...
              <input type="password" name="password" id="password" class="form-input" placeholder="Kosongkan jika tidak diubah" style="padding-left:2.5rem;padding-right:2.75rem;" />
          ...
          <div class="form-group" style="margin:0;">
            ...
            <div class="input-group">
              ...
              <select name="role" id="role" class="form-select" required style="padding-left:2.5rem;">
                <option value="admin"          {{ old('role', $user->role) === 'admin'          ? 'selected' : '' }}>Administrator (Akses Penuh)</option>
                <option value="petugas_gudang" {{ old('role', $user->role) === 'petugas_gudang' ? 'selected' : '' }}>Petugas Gudang (Penjualan & Peramalan)</option>
              </select>
            </div>
          </div>
